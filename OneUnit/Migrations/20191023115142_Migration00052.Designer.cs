...
namespace OneUnit.Migrations
{
    ...
    [Migration("20191023115142_Migration00052")]
    partial class Migration00052
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneUnit.Areas.QC.Data.Entities.PauseTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("BreakDate");

                    b.Property<int?>("HourId");

                    b.Property<byte?>("HourId1");

                    b.HasKey("Id");

                    b.HasIndex("HourId1");

                    b.ToTable("PauseTime","QC");
                });
            ...
            modelBuilder.Entity("OneUnit.Areas.QC.Data.Entities.Site", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("OneUnit.Areas.QC.Data.Entities.TypeOfCorn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("OneUnit.Areas.Transit.Data.Entities.ProjectPlan", b =>
                {
                    ...
                    b.Property<string>("OstadKarCodes");

                    b.Property<string>("OstadKarList");

                    b.Property<int?>("PersonId");

                    b.Property<int?>("ProjectId");

                    b.Property<string>("SarparastCodes");

                    b.Property<string>("SarparastList");
            ...
            modelBuilder.Entity("OneUnit.Areas.Transit.ViewModels.EnableWorkerViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("EnableWorkerViewModels");
                });

            modelBuilder.Entity("OneUnit.Areas.Transit.ViewModels.ProjectPlanInCurrentDateViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ProjectPlanInCurrentDateViewModels");
                });
            ...
            modelBuilder.Entity("OneUnit.Areas.QC.Data.Entities.Company", b =>
                {
                    b.HasOne("OneUnit.Areas.QC.Data.Entities.Site", "Site")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("OneUnit.Areas.QC.Data.Entities.QualityDesign", b =>
                {
                    ...
                    b.HasOne("OneUnit.Areas.QC.Data.Entities.TypeOfCorn", "TypeOfCorn")
                        .WithMany("QualityDesigns")
                        .HasForeignKey("TypeOfCornId");
                });
